package br.com.chaves.service;

import br.com.chaves.dto.BoardColumnInfoDTO;
import br.com.chaves.exception.CardBlockedException;
import br.com.chaves.exception.CardFinishedException;
import br.com.chaves.exception.EntityNotFoundException;
import br.com.chaves.persistence.dao.BlockDAO;
import br.com.chaves.persistence.dao.CardDAO;
...
import static br.com.chaves.persistence.entity.BoardColumnKindEnum.FINAL;
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try{
            ...
            if(currentColumn.kind().equals(FINAL)){
                throw new CardFinishedException("O card já foi finlizado.");
            }
